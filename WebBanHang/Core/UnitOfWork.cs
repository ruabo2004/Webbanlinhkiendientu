...
namespace WebBanLinhKienDienTu.Core
{
    public class UnitOfWork
    {
        ...
        private ExcludeCouponRepository excludeCouponRepository;
        ...
        public MemberRankRepository MemberRank
        {
            get
            {
                if (memberRankRepository == null)
                    memberRankRepository = new MemberRankRepository(_dbContext);
                return memberRankRepository;
            }
        }

        public CouponRepository Coupon
        {
            get
            {
                if (couponRepository == null)
                    couponRepository = new CouponRepository(_dbContext);
                return couponRepository;
            }
        }

        public ExcludeCouponRepository ExcludeCoupon
        {
            get
            {
                if (excludeCouponRepository == null)
                    excludeCouponRepository = new ExcludeCouponRepository(_dbContext);
                return excludeCouponRepository;
            }
        }
