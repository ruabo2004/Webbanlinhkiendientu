...
namespace WebBanLinhKienDienTu.Controllers
{
    public class ContactController : BaseController
    {
        ...
        public ActionResult SendContact(ContactViewModel model)
        {
            ...
            {
                result.message = "Rất tiếc! Có vấn đề xảy ra, nên không thể gửi liên hệ được, vui lòng thử lại";
            ...
            if (oldContact != null)
            {
                ...
                if (timeDelay <= 60)
                {
                    result.message = "Phát hiện gửi nhiều lần, vui lòng không gửi nhiều lần cùng lúc";
                    return Content(JsonConvert.SerializeObject(result), "application/json");
                }
            }
