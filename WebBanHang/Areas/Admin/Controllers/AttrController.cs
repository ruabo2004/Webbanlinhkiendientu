...
namespace WebBanLinhKienDienTu.Areas.Admin.Controllers
{
    ...
    public class AttrController : AdminBaseController
    {
        ...
        public ActionResult LoadAttr()
        {
            ...
            var attrs = Repository.Create<WebBanLinhKienDienTu.Models.Attribute>()
                                    .FetchAll()
        ...
        [HttpPost]
        public ActionResult InsertAttr(WebBanLinhKienDienTu.Models.Attribute attr)
        {
            ...
            var repo = Repository.Create<WebBanLinhKienDienTu.Models.Attribute>();
        ...
        public ActionResult AttrInfo(int? id)
        {
            ...
            var attr = Repository.Create<WebBanLinhKienDienTu.Models.Attribute>().FindById(id);
            if (attr == null)
            {
                result.status = false;
        ...
        public ActionResult UpdateAttr(WebBanLinhKienDienTu.Models.Attribute attr)
        {
            dynamic result = new ExpandoObject();
            ...
            result.message = "Chúc mừng bạn đã thay đổi thành công thông tin thuộc tính";
            return Content(JsonConvert.SerializeObject(result), "application/json");
        }
    }
}